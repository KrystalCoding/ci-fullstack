...
SECRET_KEY = 'django-insecure-r7k=twq0ke8=v)ew*-q-+1!(+)@91bwx@-0m(k5rw09&yhh7l*'
...
if development:
    ...
    DATABASES = {
        'default': dj_database_url.parse(os.environ.get('postgres://zywgcale:BymbMLj82f4uT-8gfisyYUqpBpjGFZvG@dumbo.db.elephantsql.com/zywgcale'))
    }
